...
class ApplicationLocalizations {
  ...
  static const LocalizationsDelegate<ApplicationLocalizations> delegate = _AppLocalizationsDelegate();
  ...
  Future<bool> load() async {
    ...
    String jsonString =
    await rootBundle.loadString('assets/languages/$selectedCode.json');
